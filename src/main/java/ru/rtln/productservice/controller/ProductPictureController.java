...
public class ProductPictureController {
    ...
    public SuccessModel<ProductPictureInfo> addCoverToBook(@RequestParam("picture")
        ...
        var uploadCover = productPictureService.addPictureToProduct(picture, productId, authUser);
